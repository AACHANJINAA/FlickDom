...
{
    public sealed class InSeongPlayerScoreHud : MonoBehaviour
    {
        ...
        [SerializeField] private Vector2 turnOffset = new Vector2(-120f, -76f);
        ...
        [SerializeField] private Color scoreTextColor = new Color(1f, 0.94f, 0.78f, 1f);
        [SerializeField] private Color turnTextColor = new Color(0.24f, 0.13f, 0.055f, 1f);
        ...
        [SerializeField] private Sprite scoreCardP1Sprite;
        [SerializeField] private Sprite scoreCardP2Sprite;
        [SerializeField] private Sprite buttonSprite;
        [SerializeField] private Vector2 scoreCardSize = new Vector2(320f, 167f);
        [SerializeField] private Vector2 scoreCardOffset = new Vector2(18f, -16f);
        ...
        private void BuildHud()
        {
            ...
            CreateScoreCard("Player 1 Card", TextAnchor.UpperLeft,
                new Vector2(scoreCardOffset.x, scoreCardOffset.y), scoreCardP1Sprite);
            CreateScoreCard("Player 2 Card", TextAnchor.UpperRight,
                new Vector2(-scoreCardOffset.x, scoreCardOffset.y), scoreCardP2Sprite);

            player1Text = CreateScoreText("Player 1 Score", TextAnchor.UpperLeft, scoreTextColor, player1Offset);
            player2Text = CreateScoreText("Player 2 Score", TextAnchor.UpperRight, scoreTextColor, player2Offset);
            player1TurnText = CreateTurnText(
                "Player 1 Turn",
                TextAnchor.UpperLeft,
                turnTextColor,
                player1Offset + turnOffset);
            player2TurnText = CreateTurnText(
                "Player 2 Turn",
            ...
            Sprite sprite)
        {
            ...
            rectTransform.sizeDelta = scoreCardSize;
            rectTransform.anchoredPosition = anchoredPosition;

            float x = alignment == TextAnchor.UpperLeft ? 0f : 1f;
            rectTransform.anchorMin = new Vector2(x, 1f);
            rectTransform.anchorMax = new Vector2(x, 1f);
            rectTransform.pivot = new Vector2(x, 1f);
            ...
            Vector2 anchoredPosition)
        {
            ...
            text.alignment = alignment == TextAnchor.UpperLeft
            ...
            Vector2 anchoredPosition)
        {
            ...
            Text text = textObject.AddComponent<Text>();
            text.font = ResolveFont();
            text.fontSize = Mathf.Max(18, fontSize - 7);
            text.fontStyle = FontStyle.Bold;
        ...
        private Font ResolveFont()
        {
            ...
            {
                resolvedFont = Resources.Load<Font>(bundledFontResourcePath);
                if (resolvedFont != null)
                {
                    return resolvedFont;
                }
            ...
            UnityEngine.Events.UnityAction onClick)
        {
            ...
            rectTransform.pivot = new Vector2(0.5f, 0.5f);
            rectTransform.anchoredPosition = anchoredPosition;
            rectTransform.sizeDelta = FitFixedSpriteInside(size, buttonSprite);
